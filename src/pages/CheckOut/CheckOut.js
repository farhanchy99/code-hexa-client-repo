...
const CheckOut = () => {
    ...
    return (
        <div className='bg-amber-400 py-12 m-10'>
            <div className='w-3/4 container m-auto'>
            {
                courseCheck.map(course=> 
                <div key={course.id} className=''>
                    <div className="bg-base-100 shadow-xl p-5 block lg:flex items-center rounded-lg">
                    <div className='w-full lg:w-2/6'><img src={course.img} alt="Courses"/></div>
                    <div className="ml-5">
                        ...
                        <div className="mt-5 block lg:flex">
                            <button onClick={success} className="btn btn-success mr-5 mb-5">Check Out Now</button>
