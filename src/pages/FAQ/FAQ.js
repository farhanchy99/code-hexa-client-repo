    ...
    return (
        <div className='container m-auto mb-10'>
            ...
            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                ...
                <div className="collapse-content"> 
                    <p>tabIndex={0} Learning web design might be right for you if you’re interested in carving out a space for yourself on the internet or helping individuals or businesses do so. You might be a business owner who needs to create an online storefront, or perhaps you're an artist who simply wants to create a site that shows off your portfolio. Web design is an ideal hobby or career path for anyone who is passionate about engaging with online communities and doesn't mind spending lots of time in front of the computer screen.</p>
                </div>                                                  
            </div>
        </div>
    );
